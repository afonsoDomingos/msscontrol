...
const FornecedorFormModal = ({ isOpen, onClose, formData, setFormData, onSubmit, isEditing, isSubmitting }) => (
  ...
  const fetchFornecedores = useCallback(async () => {
    try {
      ...
      if (Array.isArray(data)) {
        ...
        console.warn('Unexpected API response for fornecedores:', data);
        setFornecedores([]);
      }
    } catch (err) {
      console.error(err);
